*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEMP_1
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEMP_1              .
...
CALL FUNCTION 'VIEWPROC_ZEMP_1'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEMP_1-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEMP_1_EXTRACT
TOTAL = ZEMP_1_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEMP_1-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEMP_1'
...
TOTAL = ZEMP_1_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEMP_1-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEMP_1-UPD_FLAG NE SPACE.
